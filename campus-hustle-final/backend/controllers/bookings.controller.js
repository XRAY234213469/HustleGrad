...
const create = asyncHandler(async (req, res) => {
  ...
  const result = await db.query(
    `INSERT INTO bookings (buyer_id, listing_id, scheduled_date, status)
  ...
  res.status(201).json({
    success: true,
    message: 'Booking request sent. Coordinate payment directly with the vendor on delivery.',
...
module.exports = { create, getVendorNotifications, markComplete, submitReview, getReviews };
